    ...
    public static function parseProvider(): array
    {
        return [
            ...
            '* 12 FETCH (ENVELOPE ...)' => [
                ...
                new FetchData(12, envelope: new Envelope(
            ...
            '+ Ready for additional command text' => ["+ Ready for additional command text\r\n", new CommandContinuation('Ready for additional command text')],
        ];
    }
}